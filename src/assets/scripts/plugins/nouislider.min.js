...
! function(a) {
    ...
    function m() {
        const a = void 0 !== window.pageXOffset,
    ...
    function S(c, e, i) {
        function o(b, c) {
            const d = a(b, e.cssClasses.origin),
        ...
        function A(a, b) {
            a.preventDefault();
            let c, d, e = 0 === a.type.indexOf("touch"),
        ...
        function I(a, b) {
            ...
            const d = z(ea.move, document.documentElement, G, {
        ...
        function Y() {
            return ga.map(function(a, b) {
                let c = ja.getNearbySteps(a),
                    d = ka[b],
                    e = c.thisStep.step,
                    f = null;
                e !== !1 && d + e > c.stepAfter.startValue && (e = c.stepAfter.startValue - d), f = d > c.thisStep.startValue ? c.thisStep.step : c.stepBefore.step !== !1 && d - c.stepBefore.highestStep, 100 === a ? e = null : 0 === a && (f = null);
                const g = ja.countStepDecimals();
